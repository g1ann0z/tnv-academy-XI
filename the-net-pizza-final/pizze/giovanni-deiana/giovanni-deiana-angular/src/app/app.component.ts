...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [CommonModule, NavbarComponent, HeaderComponent, AlternativeComponent, CarouselComponent, FooterComponent, HeaderComponent, IngredientsComponent, NutritionalComponent, RecipeComponent, VideoComponent],
